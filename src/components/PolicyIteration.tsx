...
const PolicyIteration: React.FC = () => {
  ...
  const initializeGrid = (): GridCell[][] => {
    return [
      [{ value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }, { value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }, { value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }, { value: 0, direction: null, isExit: true, exitValue: 1 }],
      [{ value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }, { isWall: true, value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }, { value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }, { value: 0, direction: null, isExit: true, exitValue: -1 }],
      [{ value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }, { value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }, { value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }, { value: 0, direction: 'north', qValues: { north: 0, south: 0, east: 0, west: 0 } }],
    ];
  };
  ...
  const setCellValue = (row: number, col: number, newGrid: GridCell[][], oldGrid: GridCell[][]) => {
    ...
    cell.value = 0;
    const key = cell.direction || 'north';
    const directions = getDirections(key);
    directions.forEach((direction) => {
      const nextCell = getNextCell(row, col, direction, oldGrid);
      const discountedValue = nextCell.value * discount + reward;
      cell.value += direction == key ? (1 - noiseFactor / 100) * discountedValue : (noiseFactor / 200) * discountedValue;
    })
  };
